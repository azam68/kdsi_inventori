...
<head>
	...
	<title>Sistem Inventory TOKO ISTIKAH</title>
	...
	<style>
		body {
	          background: url(img/bg02.jpg) no-repeat fixed;
...
<body>
	...
	<h2><center>SELAMAT DATANG DI</h2>
	<h1><center>Sistem Informasi Inventory Barang</h1>
	<h1><center>TOKO ISTIKAH</h1></div>
...
<?php
		...
		if ($login) {
        	...
        	} elseif ($data['level'] == 'admin' && $level == 'admin') {
            	$_SESSION['admin'] = $data['id'];
            	header("location:index.php");
        	} elseif ($data['level'] == 'petugas' && $level == 'petugas') {
